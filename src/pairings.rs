...
impl MillerLoopResult {
    ...
    pub fn final_exponentiation(&self) -> Gt {
        let target = ArkTargetField {
            c0: ark_bls12_381::Fq6 {
                c0: ark_bls12_381::Fq2 {
                    c0: ark_ff::Fp {
                        0: ark_ff::BigInt(self.0.c0.c0.c0.0),
                        1: ark_std::marker::PhantomData,
                    },
                    c1: ark_ff::Fp {
                        0: ark_ff::BigInt(self.0.c0.c0.c1.0),
                        1: ark_std::marker::PhantomData,
                    },
                },
                c1: ark_bls12_381::Fq2 {
                    c0: ark_ff::Fp {
                        0: ark_ff::BigInt(self.0.c0.c1.c0.0),
                        1: ark_std::marker::PhantomData,
                    },
                    c1: ark_ff::Fp {
                        0: ark_ff::BigInt(self.0.c0.c1.c1.0),
                        1: ark_std::marker::PhantomData,
                    },
                },
                c2: ark_bls12_381::Fq2 {
                    c0: ark_ff::Fp {
                        0: ark_ff::BigInt(self.0.c0.c2.c0.0),
                        1: ark_std::marker::PhantomData,
                    },
                    c1: ark_ff::Fp {
                        0: ark_ff::BigInt(self.0.c0.c2.c1.0),
                        1: ark_std::marker::PhantomData,
                    },
                },
            },
            c1: ark_bls12_381::Fq6 {
                c0: ark_bls12_381::Fq2 {
                    c0: ark_ff::Fp {
                        0: ark_ff::BigInt(self.0.c1.c0.c0.0),
                        1: ark_std::marker::PhantomData,
                    },
                    c1: ark_ff::Fp {
                        0: ark_ff::BigInt(self.0.c1.c0.c1.0),
                        1: ark_std::marker::PhantomData,
                    },
                },
                c1: ark_bls12_381::Fq2 {
                    c0: ark_ff::Fp {
                        0: ark_ff::BigInt(self.0.c1.c1.c0.0),
                        1: ark_std::marker::PhantomData,
                    },
                    c1: ark_ff::Fp {
                        0: ark_ff::BigInt(self.0.c1.c1.c1.0),
                        1: ark_std::marker::PhantomData,
                    },
                },
                c2: ark_bls12_381::Fq2 {
                    c0: ark_ff::Fp {
                        0: ark_ff::BigInt(self.0.c1.c2.c0.0),
                        1: ark_std::marker::PhantomData,
                    },
                    c1: ark_ff::Fp {
                        0: ark_ff::BigInt(self.0.c1.c2.c1.0),
                        1: ark_std::marker::PhantomData,
                    },
                },
            },
        ...
        let result = sp_crypto_ec_utils::bls12_381::final_exponentiation(target.encode()).unwrap();

        let result = <ArkScale<
            ark_ec::pairing::PairingOutput<ark_ec::bls12::Bls12<ark_bls12_381::Config>>,
